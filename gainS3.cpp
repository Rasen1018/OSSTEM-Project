...
int main(int argc, char** argv)
{
	...
	if ((fp = fopen("./S3/MTF_H.raw", "rb")) == NULL) {
	...
	fclose(fp);
	// 폴더 내 raw 파일 모두 읽어오기
	std::string path = "./S3/Gain3/";

	handle = _findfirst("./S3/Gain3/*.raw", &fd);
	...
	if ((fp = fopen("./S3/GAIN_MTF_H.raw", "wb")) == NULL) {
